...
export const rulers: Record<string, Ruler> = {
  ...
  nabonidus: {
    id: 'nabonidus',
    name: { en: 'Nabonidus', fa: 'نبونعید' },
    title: { en: 'King of Babylon', fa: 'پادشاه بابل' },
    dynastyId: 'neo_babylonian',
  ...
  pukkusati: {
    id: 'pukkusati',
    name: { en: 'Pushkyakarasaoti', fa: 'پوستی' },
    title: { en: 'King of Gandhara', fa: 'پادشاه گندارا' },
    dynastyId: 'gandhara',
    rulerType: 'Central Monarch',
    startDate: -550,
    endDate: -500,
